...
| CLM-04 | 安全审批与受控动作 | I/T(partial) | “light Action Gateway 默认 fail-closed，校验 HMAC 审批凭证、audience、管理员令牌、Runbook/目标/参数/hash/expiry 和幂等；动作仍为 fixture，审批记录未数据库绑定” | DB 绑定 approval、TokenReview、消费次数、目标漂移、并发/重放测试 |
