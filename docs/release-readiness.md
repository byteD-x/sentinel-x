...
- Alert Ingress 已校验时间戳、nonce、HMAC 和有界 body，并提供版本化 Alertmanager webhook 转换；full profile 已使用 PostgreSQL 唯一约束和原子事务持久化 nonce claim，真实 Alertmanager/观测栈联调仍未完成。
