...
| P1 | 事故回放目前主要是内存/SQLite 快照，SSE 已支持 `retry`、heartbeat、Last-Event-ID 与 REST gap 补读，但持久发布和异步导出仍未完成 | 刷新、重启、复盘和跨人协作可信度不足 | PostgreSQL timeline/outbox + 跨进程 SSE 发布 + 脱敏事故包 hash |
